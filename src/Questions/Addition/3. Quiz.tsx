...
const Quiz: React.FC<{ level: string }> = ({ level }) => {
    ...
    useEffect(() => {
        const fetchQuestions = () => {
            const questionsRef = ref(database, `questions/addition/${level}`);
    ...
    const handleAnswerClick = (answer: string) => {
        ...
        setFeedbackClass(answer === correctAnswer ? 'feedback-correct' : 'feedback-incorrect'); // Define a classe de feedback
        setIsAnswered(true);
